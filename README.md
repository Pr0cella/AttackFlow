...
- **Containment**: Embedded iframes are sandboxed (`allow-scripts allow-same-origin allow-modals`); the STIX Composer iframe also has `allow-downloads` so its bundle export works.
