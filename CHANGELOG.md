...
- **Composer Structural Validation**: Composer identifiers and references, dictionary/hash/extension keys, kill-chain values, granular-marking selectors and timestamps are validated against the formats STIX 2.1 defines instead of being silently rewritten
