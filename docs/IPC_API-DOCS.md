...
- Iframe containment: iframe sandbox is enabled (`allow-scripts allow-same-origin allow-modals`); the STIX Composer iframe additionally has `allow-downloads` for bundle export.
